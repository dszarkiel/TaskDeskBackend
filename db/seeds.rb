...
user1 = User.create(first_name:"Dom", last_name:"Szar", email:"dom@gmail.com", username:"domszar", password:"abc")
user2 = User.create(first_name:"John", last_name:"Doe", email:"john@gmail.com", username:"johndoe", password:"abc")
